...
import { IconPokeBall } from './Icon'

const navigation = [
    { name: 'Pokemones', href: '#', current: true },
    { name: 'Evoluciones', href: '#', current: false },
    { name: 'AppPokedex', href: '#', current: false },
                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <a href="" className="flex flex-shrink-0 items-center text-current hover:text-slate-600">
                                    <span className="poke pokefont flex items-center  font-bold text-3xl  text-red-600"><i><IconPokeBall /></i>POKE</span><span className="wind pokefont flex items-center  font-bold text-3xl  text-cyan-400">WIND</span>
                                </a>
